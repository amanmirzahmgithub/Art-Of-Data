...
**I wrote one function that found the average speed, one that counted the number of digimon with a specific type and attribute, and one to build a team of digimon with 15 memory and an attack of over 300.** Some parts of this lab were challenging, however I did learn a lot as a result of this challenge. 
